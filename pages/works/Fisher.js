...
const unityContext = new UnityContext({
  loaderUrl: '../FisherBuild/Fisher_loIs_gold_spike.loader.js',
  dataUrl: '../FisherBuild/Fisher_loIs_gold_spike.data',
  frameworkUrl: '../FisherBuild/Fisher_loIs_gold_spike.framework.js',
  codeUrl: '../FisherBuild/Fisher_loIs_gold_spike.wasm'
})

const WindowsYouLink = '../FisherBuild/Fisher - gold spike - Windows Build.zip'
const MacYouLink = '../FisherBuild/Fisher - gold spike - Mac Build.zip'
